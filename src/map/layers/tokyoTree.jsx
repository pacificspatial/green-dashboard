...
const SourceName = "tokyo-tree"

export const LayerName = {
    Circle: {id: "tokyo-tree-circle-layer", at: 2},
    Buffer: {id: "tokyo-tree-buffer-layer", at: 1},
}

const MapTokyoTreeLayer = ({map, filter, visible, style, onClick, onInit}) => {
    ...
    const loadUrl = useCallback(_.debounce(() => {
        ...
        if (!_.isEmpty(appState.user?.office_uid)) {
            wheres.push(`properties->>'office_uid' = 'LX96-QCSS-TW4E-6HQ6'`)
        }
...
MapTokyoTreeLayer.propTypes = {
    ...standardLayerProps,
    filter: PropTypes.array,
    onClick: PropTypes.func,
}

export default MapTokyoTreeLayer
