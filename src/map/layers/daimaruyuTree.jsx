...
const SourceName = "daimaruyu-tree"

export const LayerName = {
    Circle: {id: "daimaruyu-tree-circle-layer", at: 2},
    Buffer: {id: "daimaruyu-tree-buffer-layer", at: 1},
}

const MapDaimaruyuTreeLayer = ({map, filter, visible, style, onClick, onInit}) => {
    ...
    const loadUrl = useCallback(_.debounce(() => {
        ...
        if (!_.isEmpty(appState.user?.office_uid)) {
            wheres.push(`properties->>'office_uid' = 'CECZ-7464-MVP9-999A'`)
        }
...
MapDaimaruyuTreeLayer.propTypes = {
    ...standardLayerProps,
    filter: PropTypes.array,
    onClick: PropTypes.func,
}

export default MapDaimaruyuTreeLayer
