...
3D都市モデル（3DTiles、建築物モデル・植生モデル等）を Amazon S3 に格納します。3D都市モデル（3DTiles） は、[G空間情報センター](https://front.geospatial.jp/)からダウンロードしてください。植生モデル（LOD1,2）のCityGML、3DTilesは、本リポジトリのFMEワークスペースで作成することが可能です。
